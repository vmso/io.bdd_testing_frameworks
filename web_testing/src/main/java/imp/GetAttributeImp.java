...
public class GetAttributeImp extends GetAttributeHelper {
    ...
    @And("Get text of {string} and store it in scenario store with <key> and default wait")
    ...
    @And("Get text of {string} and store it in scenario store with {key}")
    ...
    @And("Wait {long} presence of <element> then get text and store it in scenario store with {key}")
    ...
    @And("Wait {long}and poling ever {string} millis presence of <element> then get text and store it in scenario store with {key}")
    ...
    @And("Get {string} attribute of {string} and store it in scenario store with <key> and default wait")
    ...
    @And("Get {string} attribute of {string} and store it in scenario store with <key> without any wait")
    ...
    @And("Get inner text of {string} and store it in scenario store with <key> and default wait")
