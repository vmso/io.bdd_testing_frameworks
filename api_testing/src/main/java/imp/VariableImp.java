...
public class VariableImp {
    ...
    @And("Store variable {string} = {string} during scenario")
    ...
    @And("Store {string} file's value from classpath with <key> during scenario")
    ...
    @And("Store {string} json file's value from classpath with {string} during scenario")
    ...
    @And("Store {string} json file's value from classpath with {string} during spec")
    ...
    @And("Store {string} json file's value from classpath with {string} during suit")
    ...
    @And("Store variable {string} = {string} during suite")
    ...
    @And("Store {string} file's value from classpath with {string} during suite")
    ...
    @And("Store variable {string} = {string} during spec")
    ...
    @And("Store {string} file's value from classpath with {string} during spec")
    ...
    @And("Store table as map during scenario with {string}")
